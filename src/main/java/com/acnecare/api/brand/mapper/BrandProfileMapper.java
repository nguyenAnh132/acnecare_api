...
public interface BrandProfileMapper {
        BrandProfile toBrandProfile(BrandProfileCreationRequest request);

        BrandProfileResponse toBrandProfileResponse(BrandProfile brandProfile);

        void updateBrand(BrandProfileCreationRequest request, @MappingTarget BrandProfile brandProfile);
}
